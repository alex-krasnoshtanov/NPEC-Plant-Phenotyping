...
# Import wrapper
from ot2_env_exploration import OT2Env

print("="*80)
print("Testing Alex's Model: ppo_individual_5mm")
print("="*80)

# Load the model
model_filename = "ppo_individual_5mm.zip"
...
output_dir = task11_dir / "results", "individual"
